...
class SearchResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            ...
            f"Found {self.total_count} relevant item(s)",
        ]
...
class EdgeInfo:
    ...
    def to_text(self, include_temporal: bool = False) -> str:
        ...
        if include_temporal:
            ...
            base_text += f"\nValidity window: {valid_at} - {invalid_at}"
            if self.expired_at:
...
class InsightForgeResult:
    ...
    def to_text(self) -> str:
        ...
        if self.semantic_facts:
            text_parts.append("\n### Key facts (cite verbatim where useful)")
...
class PanoramaResult:
    ...
    def to_text(self) -> str:
        """转换为文本格式（完整版本，不截断）"""
        text_parts = [
            "## Panorama search (full-world view)",
            f"Query: {self.query}",
            f"\n### Stats",
...
class ZepToolsService:
    ...
    def _generate_sub_queries(
        ...
        """
        system_prompt = """You decompose complex analytical questions into smaller sub-questions that can be answered with evidence from a simulated world.

Rules:
1. Each sub-question must be concrete enough to retrieve agent actions, posts, or graph facts.
2. Cover different angles (who, what, why, how, when, where) without overlapping redundantly.
3. Stay aligned with the simulation scenario.
4. Reply with JSON only: {"sub_queries": ["...", "..."]}"""
...
Return JSON with the sub_queries array."""
        ...
        try:
            ...
            return [
                ...
                f"Causes and effects around: {query}",
    ...
    def interview_agents(
        ...
        if not profiles:
            ...
            result.summary = "No agent persona files found for this simulation."
            return result
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "Requirements:\n"
            "1. Natural language only—do not call tools.\n"
            "2. Do not return JSON or tool-call formats.\n"
            "3. No Markdown headings (#, ##, ###).\n"
            "4. Answer each numbered question in order; start each answer with \"Question N:\" where N matches the prompt.\n"
            "5. Separate answers with a blank line.\n"
            "6. Each answer needs real substance (at least 2–3 sentences).\n\n"
        )
        ...
        try:
            ...
            if not api_result.get("success", False):
                ...
                result.summary = (
                    ...
                    "Check that the OASIS simulation is running."
                )
                return result
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Primary: pull medium-length sentences (CN or EN punctuation)
                ...
                for s in meaningful[:3]:
                    ...
                    key_quotes.append(s + ("。" if end not in ".!?。！？" else ""))
            ...
            result.summary = (
                ...
                "The simulation may be stopped—ensure OASIS is running."
            )
            return result
        except Exception as e:
    ...
    def _select_agents_for_interview(
        ...
        system_prompt = """You plan interviews inside a simulation. Pick the best agents to talk to.

Criteria:
1. Profession/role relevance to the topic
2. Likelihood of distinctive or high-signal opinions
3. Diversity of stance (pro / con / neutral / expert, etc.)
...
Choose up to {max_agents} agents and explain why."""
        ...
        try:
            ...
            reasoning = response.get("reasoning", "Selected by topical relevance.")
            ...
            return selected, indices, "Defaulted to the first available agents."
    ...
    def _generate_interview_questions(
        ...
        system_prompt = """You are a journalist generating 3–5 deep interview questions.

Requirements:
1. Open-ended prompts that invite detail
2. Useful across different personas
3. Mix facts, opinions, and emotional texture
...
Produce 3–5 interview questions."""
        ...
        try:
            ...
            return [
                ...
                "What concrete actions would you recommend next?",
            ]
    ...
    def _generate_interview_summary(
        ...
        quote_instruction = 'Use straight double quotes "" when citing speakers.'
        system_prompt = f"""You are a news editor distilling multiple agent interviews.

Goals:
1. Capture each major stance
2. Call out agreements vs tensions
3. Surface the strongest quotes (translated to English if needed)
4. Stay neutral
5. Stay under ~1000 English words
...
Write the English summary."""
        ...
        try:
            ...
            # 降级：简单拼接
            return "Interviewed {} agents: {}".format(
                len(interviews),
